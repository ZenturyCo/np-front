...
export default function AIAssistant() {
  ...
  return (
    <div className="flex -m-4 lg:-m-6 h-[calc(100vh-4rem)] flex-col bg-background">
      {/* Header */}
      <div className="flex items-center gap-3 border-b px-4 lg:px-6 py-3 shrink-0">
      ...
      {/* Messages */}
      <div className="flex-1 space-y-4 overflow-auto px-4 lg:px-6 py-5">
        {messages.map((m, i) => (
